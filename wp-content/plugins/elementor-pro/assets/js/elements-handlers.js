...
initModal(){let modal;this.getModal=()=>{if(!modal){const settings=this.getDocumentSettings(),id=this.getSettings('id'),triggerPopupEvent=eventType=>{const event='elementor/popup/'+eventType;window.dispatchEvent(new CustomEvent(event,{detail:{id,instance:this}}));};let classes='elementor-popup-modal';if(settings.classes){classes+=' '+settings.classes;}
...
return true;}
onPopupHide(){elementorFrontend.elements.$window.on('elementor/popup/hide',()=>{this.utils.incrementImpressionsCount();});}}
